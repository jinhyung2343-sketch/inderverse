...
const baseArtworks: ExploreArtwork[] = [
  {
    ...
    episodes: [
      ...
      { id: 'ep-3', title: '3화. 새벽의 거래자', accessState: 'wait_free', accessLabel: '기다리면 무료', waitFreeHours: 23, preview: '거래가 끝나는 시각, 가장 늦게 남은 사람만이 들을 수 있는 목소리가 있다.', body: ['기다리면 무료 회차입니다.'] },
  ...
  },
  {
    ...
    episodes: [
      ...
      { id: 'ep-2', title: '2화. 저녁 버스 정류장', accessState: 'wait_free', accessLabel: '기다리면 무료', waitFreeHours: 11, preview: '돌아갈 곳을 정하지 못한 사람들은 늘 버스 정류장에서 조금 더 오래 머문다.', body: ['기다리면 무료 회차입니다.'] },
  ...
  },
  {
    ...
    episodes: [
      ...
      { id: 'ep-2', title: '2화. 얼어붙은 메시지', accessState: 'purchased', accessLabel: '구매됨', preview: '읽힌 적 없는 메시지는 시간이 흐를수록 더 차가워진다.', body: ['이미 구매된 회차입니다.'] },
  ...
  },
  {
    ...
    episodes: [
      ...
      { id: 'ep-3', title: '3화. 잔향을 남긴 AI', accessState: 'wait_free', accessLabel: '기다리면 무료', waitFreeHours: 6, preview: '삭제된 줄 알았던 인공 지능의 잔향이 승무원들의 대화를 뒤틀기 시작한다.', body: ['기다리면 무료 회차입니다.'] },
    ],
  },
  {
    id: 'midnight-letters',
  ...
  },
  {
    ...
    episodes: [
      ...
      { id: 'ep-2', title: '2화. 붉은 조명 아래', accessState: 'purchased', accessLabel: '구매됨', preview: '붉은 경고등이 켜진 뒤에는 누구도 안전지대라고 부를 수 없다.', body: ['이미 구매된 회차입니다.'] },
      { id: 'ep-3', title: '3화. 추격의 시작', accessState: 'wait_free', accessLabel: '기다리면 무료', waitFreeHours: 18, preview: '멈추지 않기 위해서는 먼저 버려야 할 이름이 있다.', body: ['기다리면 무료 회차입니다.'] },
    ],
  },
  {
    id: 'blade-of-mist',
    ...
    episodes: [
      ...
      { id: 'ep-2', title: '2화. 사라진 비급', accessState: 'wait_free', accessLabel: '기다리면 무료', waitFreeHours: 9, preview: '누군가는 비급을 훔쳤고, 누군가는 그 사실을 오래전부터 알고 있었다.', body: ['기다리면 무료 회차입니다.'] },
  ...
  },
  {
    ...
    episodes: [
      ...
      { id: 'ep-3', title: '3화. 문 뒤의 목소리', accessState: 'wait_free', accessLabel: '기다리면 무료', waitFreeHours: 15, preview: '닫힌 문은 침묵보다 더 정확하게 누군가의 존재를 증명한다.', body: ['기다리면 무료 회차입니다.'] },
    ],
  },
  {
    id: 'gravity-bloom',
    ...
    episodes: [
      ...
      { id: 'ep-2', title: '2화. 서로의 거리', accessState: 'purchased', accessLabel: '구매됨', preview: '가까울수록 말하기 어려운 감정이 있다.', body: ['이미 구매된 회차입니다.'] },
